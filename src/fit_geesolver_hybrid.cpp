...
#include "update_beta_hybrid.h"


//=========================== fitting function =================================
// [[Rcpp::export]]
Rcpp::List fit_bingee_hybrid(const arma::vec & y_vector,
  ...
  for (int i=1; i<maxiter+1; i++){
    beta_vector_new = update_beta_hybrid(y_vector,
                                         model_matrix,
                                         id_vector,
                                         repeated_vector,
                                         link,
                                         ...
                                         alpha_vector,
                                         type);
    criterion_vector(i-1) = max(abs(beta_vector - beta_vector_new));
