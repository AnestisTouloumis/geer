...
#'   observation order stored in \code{object}. Ties are resolved using the
#'   natural cluster/repeated order.
#'
#' @details
...
#'
#' Hardin, J.W. and Hilbe, J.M. (2013) \emph{Generalized Estimating Equations},
